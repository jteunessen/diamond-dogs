...
- In the `Variables` tab of your `diamond_dogs_dev` you can add environment variables for the AWS Credentials
...
## Other possible items to cover:

- Local vs Remote Execution with Terraform Cloud
- Standardize Terraform Core Versions
